        ...
        <footer className="footer p-10 bg-base-200 text-base-content">
          <div>
            <div className="mb-2 flex items-center">
              <Link className="-ml-2" href="/"><Image src="/images/Face_2.png" alt="SWOP Logo" width={60} height={60} /></Link>
              <div>
                <Link href="/"><span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500 text-xl">SWOP</span><br /></Link>
          ...
          <div className="w-52">
            <p className="text-xs">Please research if swop.xyz is legal to use in your jurisdiction prior to use. swop.xyz assumes no responsibility for your use of the platform. </p>
          </div>
        </footer>
      </body>
    </html>
