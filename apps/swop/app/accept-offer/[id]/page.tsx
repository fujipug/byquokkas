    ...
    <>
      ...
      {stepper === 1 &&
        <div className='bg-neutral rounded-box py-3 px-4 drop-shadow-md'>
          <h1 className="font-semibold text-2xl text-center text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500">Congrats!</h1>
          <p className="text-lg flex items-center justify-center leading-8">
            You have successfully accepted the offer. Congratulations on your new NFTs!
          </p>
        </div>
      }
